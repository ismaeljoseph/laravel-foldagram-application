...
@section('inner-banner')
    <div class="row-fluid inner-top">
        <div class="span6 inner-content">
            <h2>About</h2>
            <p>We have a great story, and we'd love to tell you about it.
                By the way, did you watch the original Foldagram video on the front page?
            </p>
        </div>
...
<div class="span12 dcontent">
    <div class="span7 about well">
        ...
        <p>
            Everyone knows the internet provides a wonderful tool
        ...
        <p>
            This is what led Jordan Bundy to create The Foldagram
    ...
    <div class="span5 well">
        ...
        <p><a href="http://www.coloradocountrylife.com/index.php?
              option=com_content&view=article&id=1068:send-a-letter&
              catid=39:other-resources&Itemid=91">Colorado Country Life
        </a></p>
        <h4>Audio Clips</h4>
        <p><a href="http://www.youtube.com/watch?v=QT0POw0DFr8">
            The second interview with Ski Country
        </a></p>
        <p><a href="http://www.youtube.com/watch?v=MQ1ObuRkJrk">
            The first interview with Ski Country
        </a></p>
    </div>
</div>
@stop
