                ...
                <li class="da-slider">
                    <div class="da-slide row">
                        <div class="span5">
                            ...
                            <p>Thank you for visiting the Foldagram! 
                                As you explore the site and create your Foldagram!
                            </p>
                            <a href="#popup" data-toggle="modal" class="da-link create">
                                Click Here to Get Started!
                            </a>
                            <a href="#video" class="da-link video" data-toggle="modal">
                                See the Foldagram Video!
                            </a>
                        </div>
...
<div class="row-fluid fguid">
    <div class="span4 you-click">
        ...
        <ul>
            ...
            <li>Buy one at a time or start an acoount</li>
        </ul>
    </div>
